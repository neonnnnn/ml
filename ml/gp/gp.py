...
class GP(object):
    ...
    def negative_loglikelihood(self, params):
        ...
        cholesky_C = linalg.cholesky(C, lower=True)
        inv_C_times_t = linalg.cho_solve((cholesky_C, True), self.t)
    ...
    def grad_nll(self, params):
        ...
        inv_C = linalg.cho_solve((cholesky_C, True),
    ...
    def fit(self, x, y, hyper_opt_times=10, bounds=None):
        ...
        if self.type2ml:
            ...
            for i in xrange(hyper_opt_times):
                ...
                res = optimize.fmin_l_bfgs_b(self.negative_loglikelihood,
        ...
        self.cholesky_C = linalg.cholesky(self.C, lower=True)
    ...
    def decision_function(self, x):
        ...
        Trans_k_dot_inv_C = linalg.cho_solve((self.cholesky_C, True), k.T).T
        # mean.shape = (M, )
